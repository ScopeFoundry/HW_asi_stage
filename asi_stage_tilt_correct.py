...
class ASIStageControlMeasure(Measurement):
    ...
    def setup_figure(self):
        ...
        try:
            ...
            self.app.speedXYDict = {'5.00':5.00, '3.00':3.00, '1.00':1.00, '0.50':0.50, '0.10':0.10, '0.01':0.01}
            self.ui.speed_xy_comboBox.addItems(self.app.speedXYDict)
        def set_xy_speed():
            speed = self.app.speedXYDict.get(self.ui.speed_xy_comboBox.currentText())
            self.stage.settings['speed_xy'] = speed
            self.stage.settings['speed_x'] = speed
            self.stage.settings['speed_y'] = speed
        self.ui.speed_xy_comboBox.currentIndexChanged.connect(set_xy_speed)
        
        self.stage.settings.speed_x.connect_to_widget(self.ui.speed_x_doubleSpinBox)
        self.stage.settings.speed_y.connect_to_widget(self.ui.speed_y_doubleSpinBox)
        ...
        self.stage.settings.speed_z.connect_to_widget(self.ui.speed_z_doubleSpinBox)
